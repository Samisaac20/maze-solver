    ...
    <div className="top-controls">
      ...
      <div className="control-section">
        ...
        <div className="runner-buttons">
          <button className="start-button" onClick={runSolver} disabled={loading || isRunning}>
            Start Solver
          </button>
      ...
      {/* Maze Settings - Combined with Complexity */}
      <div className="control-section">
        <h3>Maze Settings</h3>
        <div className="maze-settings">
          ...
          <div className="complexity-slider-main">
            <label>
              ...
              <input
                ...
                style={{
                  background: `linear-gradient(to right, #1e40af 0%, #1e40af ${(COMPLEXITY_PRESETS.findIndex(p => p.id === selectedPreset) / 4) * 100}%, #ffffff ${(COMPLEXITY_PRESETS.findIndex(p => p.id === selectedPreset) / 4) * 100}%, #ffffff 100%)`
                }}
              />
          ...
          <div className="speed-control">
            ...
            <input
              ...
              style={{
                background: `linear-gradient(to right, #1e40af 0%, #1e40af ${((speedMs - 20) / (1000 - 20)) * 100}%, #ffffff ${((speedMs - 20) / (1000 - 20)) * 100}%, #ffffff 100%)`
              }}
            />
          </div>
        </div>
